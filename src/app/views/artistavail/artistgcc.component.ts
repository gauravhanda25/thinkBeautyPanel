        ...
        .subscribe(response => {
          ...
          if(response.json().length != 0) {
            for(let index in this.gccData){ 
              this.gccData[index].starton = new Date(moment(this.gccData[index].starton).utc().format("DD MMMM YYYY"));
              this.gccData[index].endon = new Date(moment(this.gccData[index].endon).utc().format("DD MMMM YYYY"));
            }
